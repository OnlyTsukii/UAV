 ...
 * @return      @ref gmt_ret_code_e  0 成功 <0 失败
 */
dllexport int guide_measure_convertgray2temper(int devType, int lensType, short* pGray, char* pParamLine, 
    int len, guide_measure_external_param_t* pParamExt, float* pTemper);
/**
 * @brief 将温度数据转换成Y16数据
 * @param[in]   devType     机芯型号。
 * @param[in]   lensType    镜头类型。
