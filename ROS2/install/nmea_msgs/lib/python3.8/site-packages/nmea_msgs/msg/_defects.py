...
class Metaclass_Defects(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from nmea_msgs.msg import DefectBox
...
class Defects(metaclass=Metaclass_Defects):
    ...
    _fields_and_field_types = {
        ...
        'img_width': 'float',
        'img_height': 'float',
        'defects': 'sequence<nmea_msgs/DefectBox>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('float'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['nmea_msgs', 'msg'], 'DefectBox')),  # noqa: E501
    )
