...
void fetch_function__Defects__defects(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const location_msgs::msg::DefectBox *>(
    get_const_function__Defects__defects(untyped_member, index));
  auto & value = *reinterpret_cast<location_msgs::msg::DefectBox *>(untyped_value);
  value = item;
}

void assign_function__Defects__defects(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<location_msgs::msg::DefectBox *>(
    get_function__Defects__defects(untyped_member, index));
  const auto & value = *reinterpret_cast<const location_msgs::msg::DefectBox *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Defects_message_member_array[3] = {
  {
    "img_width",  // name
  ...
  },
  {
    ...
    fetch_function__Defects__defects,  // fetch(index, &value) function pointer
    assign_function__Defects__defects,  // assign(index, value) function pointer
