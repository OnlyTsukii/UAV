...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Yaw_message_member_array[2] = {
  {
    "yaw_id",  // name
    ...
    offsetof(location_msgs::msg::Yaw, yaw_id),  // bytes offset in struct
