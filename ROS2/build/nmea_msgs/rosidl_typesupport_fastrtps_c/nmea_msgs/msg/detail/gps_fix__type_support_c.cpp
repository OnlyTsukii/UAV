...
#include "nmea_msgs/msg/detail/gps_fix__rosidl_typesupport_fastrtps_c.h"
...
using _GpsFix__ros_msg_type = nmea_msgs__msg__GpsFix;
...
static uint32_t _GpsFix__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nmea_msgs__msg__GpsFix(
...
{
  return max_serialized_size_nmea_msgs__msg__GpsFix(
    full_bounded, 0);
}
