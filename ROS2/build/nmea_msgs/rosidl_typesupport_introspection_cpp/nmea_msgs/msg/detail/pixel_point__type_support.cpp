...
{
  new (message_memory) nmea_msgs::msg::PixelPoint(_init);
}

void PixelPoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<nmea_msgs::msg::PixelPoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PixelPoint_message_member_array[2] = {
  {
    ...
    offsetof(nmea_msgs::msg::PixelPoint, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nmea_msgs::msg::PixelPoint, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PixelPoint_message_members = {
  ...
  2,  // number of fields
  sizeof(nmea_msgs::msg::PixelPoint),
...
{
  return &::nmea_msgs::msg::rosidl_typesupport_introspection_cpp::PixelPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nmea_msgs, msg, PixelPoint)() {
  return &::nmea_msgs::msg::rosidl_typesupport_introspection_cpp::PixelPoint_message_type_support_handle;
}
