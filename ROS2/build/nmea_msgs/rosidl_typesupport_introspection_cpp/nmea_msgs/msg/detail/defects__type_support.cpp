...
{
  new (message_memory) nmea_msgs::msg::Defects(_init);
}

void Defects_fini_function(void * message_memory)
{
  auto typed_message = static_cast<nmea_msgs::msg::Defects *>(message_memory);
  typed_message->~Defects();
}

size_t size_function__Defects__defects(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<nmea_msgs::msg::DefectBox> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<nmea_msgs::msg::DefectBox> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<nmea_msgs::msg::DefectBox> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Defects_message_member_array[4] = {
  {
    ...
    offsetof(nmea_msgs::msg::Defects, defect_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nmea_msgs::msg::Defects, img_width),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nmea_msgs::msg::Defects, img_height),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<nmea_msgs::msg::DefectBox>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(nmea_msgs::msg::Defects, defects),  // bytes offset in struct
    nullptr,  // default value
...
get_message_type_support_handle<nmea_msgs::msg::Defects>()
{
  return &::nmea_msgs::msg::rosidl_typesupport_introspection_cpp::Defects_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nmea_msgs, msg, Defects)() {
  return &::nmea_msgs::msg::rosidl_typesupport_introspection_cpp::Defects_message_type_support_handle;
}
