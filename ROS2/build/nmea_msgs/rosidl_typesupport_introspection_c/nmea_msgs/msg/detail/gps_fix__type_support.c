...
#include <stddef.h>
#include "nmea_msgs/msg/detail/gps_fix__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember GpsFix__rosidl_typesupport_introspection_c__GpsFix_message_member_array[2] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nmea_msgs__msg__GpsFix, gps_fix),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nmea_msgs, msg, GpsFix)() {
