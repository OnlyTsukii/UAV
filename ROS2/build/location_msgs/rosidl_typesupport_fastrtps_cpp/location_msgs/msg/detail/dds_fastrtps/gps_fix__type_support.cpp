...
#include "location_msgs/msg/detail/gps_fix__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const location_msgs::msg::GpsFix & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  location_msgs::msg::GpsFix & ros_message)
{
  // Member: gps_id
  cdr >> ros_message.gps_id;
...
{
  auto typed_message =
    static_cast<const location_msgs::msg::GpsFix *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<location_msgs::msg::GpsFix *>(
    untyped_ros_message);
...
{
  return &location_msgs::msg::typesupport_fastrtps_cpp::_GpsFix__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, location_msgs, msg, GpsFix)() {
  return &location_msgs::msg::typesupport_fastrtps_cpp::_GpsFix__handle;
}
