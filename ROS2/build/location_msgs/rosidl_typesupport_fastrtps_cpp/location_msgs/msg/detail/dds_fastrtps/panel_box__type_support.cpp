...
#include "location_msgs/msg/detail/panel_box__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const location_msgs::msg::PanelBox & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  location_msgs::msg::PanelBox & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = location_msgs::msg::PanelBox;
    is_plain =
      (
      offsetof(DataType, h) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const location_msgs::msg::PanelBox *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<location_msgs::msg::PanelBox *>(
    untyped_ros_message);
...
{
  return &location_msgs::msg::typesupport_fastrtps_cpp::_PanelBox__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, location_msgs, msg, PanelBox)() {
  return &location_msgs::msg::typesupport_fastrtps_cpp::_PanelBox__handle;
}
