...
{
  location_msgs__msg__PixelPoint * msg = (location_msgs__msg__PixelPoint *)malloc(sizeof(location_msgs__msg__PixelPoint));
  if (!msg) {
    return NULL;
  }
...
location_msgs__msg__PixelPoint__Sequence__init(location_msgs__msg__PixelPoint__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (location_msgs__msg__PixelPoint *)calloc(size, sizeof(location_msgs__msg__PixelPoint));
    if (!data) {
      return false;
    }
...
{
  location_msgs__msg__PixelPoint__Sequence * array = (location_msgs__msg__PixelPoint__Sequence *)malloc(sizeof(location_msgs__msg__PixelPoint__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  location_msgs__msg__PixelPoint__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    location_msgs__msg__PixelPoint * data =
      (location_msgs__msg__PixelPoint *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!location_msgs__msg__PixelPoint__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          location_msgs__msg__PixelPoint__fini(&data[i]);
        }
        free(data);
        return false;
      }
