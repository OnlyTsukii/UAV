...
class Metaclass_DefectBox(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from location_msgs.msg import PixelPoint
...
class DefectBox(metaclass=Metaclass_DefectBox):
    ...
    _fields_and_field_types = {
        'center': 'location_msgs/PixelPoint',
        'top_left': 'location_msgs/PixelPoint',
        'top_right': 'location_msgs/PixelPoint',
        'bottom_left': 'location_msgs/PixelPoint',
        'bottom_right': 'location_msgs/PixelPoint',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['location_msgs', 'msg'], 'PixelPoint'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['location_msgs', 'msg'], 'PixelPoint'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['location_msgs', 'msg'], 'PixelPoint'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['location_msgs', 'msg'], 'PixelPoint'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['location_msgs', 'msg'], 'PixelPoint'),  # noqa: E501
