...
{
public:
  explicit Init_Defects_img_width(::location_msgs::msg::Defects & msg)
  : msg_(msg)
  {}
...
public:
  ...
  {}
  Init_Defects_img_width defect_id(::location_msgs::msg::Defects::_defect_id_type arg)
  {
...
{
  return location_msgs::msg::builder::Init_Defects_defect_id();
}
