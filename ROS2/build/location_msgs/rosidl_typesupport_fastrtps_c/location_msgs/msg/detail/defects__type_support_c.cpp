...
#include "location_msgs/msg/detail/defects__rosidl_typesupport_fastrtps_c.h"
...
#include "location_msgs/msg/detail/defect_box__functions.h"  // defects
...
using _Defects__ros_msg_type = location_msgs__msg__Defects;
  ...
  // Field name: defects
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, location_msgs, msg, DefectBox
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: defects
  {
    ...
    if (ros_message->defects.data) {
      location_msgs__msg__DefectBox__Sequence__fini(&ros_message->defects);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name defects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_location_msgs__msg__DefectBox(
...
static uint32_t _Defects__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_location_msgs__msg__Defects(
